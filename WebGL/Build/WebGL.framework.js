...
var ASM_CONSTS = {
  7463984: function() {return Module.webglContextAttributes.premultipliedAlpha;},  
 7464045: function() {return Module.webglContextAttributes.preserveDrawingBuffer;},  
 7464109: function() {return Module.webglContextAttributes.powerPreference;},  
 7464167: function() {Module['emscripten_get_now_backup'] = performance.now;},  
 7464222: function($0) {performance.now = function() { return $0; };},  
 7464270: function($0) {performance.now = function() { return $0; };},  
 7464318: function() {performance.now = Module['emscripten_get_now_backup'];}
};
  ...
  function _WebSocketConnect(instanceId) {
  		...
  		instance.ws.onopen = function() {
  			...
  			if (webSocketState.onOpen)
  				(function(cb, a1) {  getDynCaller("vi", cb)(a1) })(webSocketState.onOpen, instanceId);
  		...
  		instance.ws.onmessage = function(ev) {
  			...
  			if (ev.data instanceof ArrayBuffer) {
  				...
  				try {
  					(function(cb, a1, a2, a3) {  getDynCaller("viii", cb)(a1, a2, a3) })(webSocketState.onMessage, instanceId, buffer, dataBuffer.length);
  				} finally {
  					_free(buffer);
  				}
  		...
  		instance.ws.onerror = function(ev) {
  			...
  			if (webSocketState.onError) {
  				...
  				try {
  				    (function(cb, a1, a2) {  getDynCaller("vii", cb)(a1, a2) })(webSocketState.onError, instanceId, msgBuffer);
  				} finally {
  					_free(msgBuffer);
  				}
  		...
  		instance.ws.onclose = function(ev) {
  			...
  			if (webSocketState.onClose)
  				(function(cb, a1, a2) {  getDynCaller("vii", cb)(a1, a2) })(webSocketState.onClose, instanceId, ev.code);
...
var asmLibraryArg = {
  ...
  "invoke_fiiiifii": invoke_fiiiifii,
  ...
  "invoke_viiiiijjii": invoke_viiiiijjii,
...
/** @type {function(...*):?} */
var dynCall_viiiiiffiiffffii = Module["dynCall_viiiiiffiiffffii"] = createExportWrapper("dynCall_viiiiiffiiffffii");

/** @type {function(...*):?} */
var dynCall_viiifffifffifffii = Module["dynCall_viiifffifffifffii"] = createExportWrapper("dynCall_viiifffifffifffii");
...
/** @type {function(...*):?} */
var dynCall_viiifffiffiii = Module["dynCall_viiifffiffiii"] = createExportWrapper("dynCall_viiifffiffiii");
...
function invoke_viifdi(index,a1,a2,a3,a4,a5) {
  var sp = stackSave();
  try {
    dynCall_viifdi(index,a1,a2,a3,a4,a5);
  } catch(e) {
    stackRestore(sp);
    if (e !== e+0) throw e;
    _setThrew(1, 0);
...
function invoke_fiiiifii(index,a1,a2,a3,a4,a5,a6,a7) {
  var sp = stackSave();
  try {
    return dynCall_fiiiifii(index,a1,a2,a3,a4,a5,a6,a7);
  } catch(e) {
    stackRestore(sp);
    if (e !== e+0) throw e;
    _setThrew(1, 0);
